...
# - EC2 Instances
# Demonstrates security best practices and least privilege access
# ============================================================================
...
# Allow HTTPS from anywhere to ALB (for future use)
...
# Allow SSH from specific CIDR (admin only)
...
# Allow application port from ALB to EC2 (8080)
resource "aws_security_group_rule" "ec2_app_port_from_alb" {
  type                     = "ingress"
  from_port                = 8080
  to_port                  = 8080
  protocol                 = "tcp"
